...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xF0222222;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xF0888888;
	...
	private void initResourcesIfNecessary() {
		...
		if (itemsPaint == null) {
			...
			itemsPaint.setTextSize(TEXT_SIZE * density * 0.6f);
		}

		if (valuePaint == null) {
			valuePaint = new TextPaint(Paint.ANTI_ALIAS_FLAG | Paint.DITHER_FLAG);
			// valuePaint.density = getResources().getDisplayMetrics().density;
			valuePaint.setTextSize(TEXT_SIZE * density * 0.6f);
	...
	public interface WheelAdapter {
		...
		/**
		 * Gets maximum item length. It is used to determine the wheel width. If
		 * -1 is returned there will be used the default wheel width.
		 * 

...
package com.story.culture.views.middleScrollView;
...
public class ContentExpandableListView extends ExpandableListView {
    ...
    public ContentExpandableListView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public ContentExpandableListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

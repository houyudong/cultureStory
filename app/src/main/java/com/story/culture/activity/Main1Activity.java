...
import com.story.culture.fragment.CommonFragment;
import com.story.culture.R;
import com.story.utils.CustPagerTransformer;
...
public class Main1Activity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WriteInfoActivity.action2WriteInfoActivity(Main1Activity.this,null,false);
            }
        });
        // 1. 沉浸式状态栏
    ...
    private void fillViewPager() {
        ...
        viewPager.setAdapter(new FragmentStatePagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                CommonFragment fragment = fragments.get(position % 3);
